...
Page({
	data: {
		...
		talentPool: [
			...
			},
			{
				...
				name: '能跑能跳',
				desc: '体育成绩一直不错',
				effectDesc: '活力+1，运气+1',
				level: 0,
				effects: { vitality: 1, luck: 1 },
			},
			{
				id: 107,
				name: '喜欢看书',
				desc: '平时没事就爱看书',
				effectDesc: '智力+1，魅力+1',
				level: 0,
				effects: { intelligence: 1, charm: 1 },
			},
			{
				id: 108,
				name: '手气还行',
				desc: '抽奖偶尔能中',
				effectDesc: '运气+1，财富+1',
				level: 0,
				effects: { luck: 1, wealth: 1 },
			},
			{
				id: 109,
				name: '人缘挺好',
				desc: '朋友比较多',
				effectDesc: '魅力+1，运气+1',
				level: 0,
			...
			// 蓝色天赋（等级2，稀有）
			{
				...
				name: '天生神力',
				desc: '从小力气就比别人大',
				effectDesc: '活力+5 | 解锁力量类特殊事件',
				level: 2,
				effects: { vitality: 5, tag: 'strength' },
			},
			{
				id: 2,
				name: '学霸附体',
				desc: '学习能力超强',
				effectDesc: '智力+5 | 解锁学习类特殊事件',
				level: 2,
				effects: { intelligence: 5, tag: 'intelligence' },
			},
			{
				id: 7,
				name: '社交达人',
				desc: '特别会说话',
				effectDesc: '魅力+3，财富+2 | 解锁商业合作事件',
				level: 2,
				effects: { charm: 3, wealth: 2, tag: 'social' },
			},
			{
				id: 9,
				name: '商业头脑',
				desc: '特别会赚钱',
				effectDesc: '智力+3，财富+2 | 解锁投资类特殊事件',
				level: 2,
				effects: { intelligence: 3, wealth: 2, tag: 'business' },
			},
			...
			// 紫色天赋（等级3，史诗）
			{
				...
				name: '家财万贯',
				desc: '出生在富裕家庭',
				effectDesc: '财富+5 | 解锁财富类特殊事件',
				level: 3,
				effects: { wealth: 5, tag: 'wealth' },
			},
			{
				id: 5,
				name: '颜值爆表',
				desc: '长得特别好看',
				effectDesc: '魅力+5 | 解锁社交类特殊事件',
				level: 3,
				effects: { charm: 5, tag: 'charm' },
			},
			{
				id: 8,
				name: '钢铁身躯',
				desc: '不容易生病受伤',
				effectDesc: '活力+3，魅力+2 | 大幅降低意外死亡概率',
				level: 3,
				effects: { vitality: 3, charm: 2, tag: 'tough' },
			},
			...
			// 橙色天赋（等级4，传说）
			{
				...
				name: '锦鲤转世',
				desc: '运气好到爆棚',
				effectDesc: '运气+5 | 大幅提升幸运事件概率',
				level: 4,
				effects: { luck: 5, tag: 'luck' },
			},
			...
			// 红色天赋（等级5，神话，概率极低）
			{
				...
				name: '修仙体质',
				desc: '天生适合修行',
				effectDesc: '智力+3，运气+2 | 大幅提高修仙概率',
				level: 5,
				effects: { intelligence: 3, luck: 2, tag: 'cultivate' },
			},
			{
				id: 10,
				name: '天选之子',
				desc: '各方面都很均衡',
				effectDesc: '全属性+2 | 解锁所有特殊事件',
				level: 5,
				effects: {
					vitality: 2,
					intelligence: 2,
			...
			// 龙虾转生专属天赋（前世技能）
			{
				id: 501,
				name: '断肢再生',
				desc: '小龙虾天生能力，断了钳子能再长出来',
				effectDesc: '活力+3 | 大幅降低受伤死亡概率',
				level: 3,
				effects: { vitality: 3, tag: 'lobster-regen' },
			},
			{
				id: 502,
				name: '无限生长',
				desc: '小龙虾终身生长，你也继承了这个能力',
				effectDesc: '全属性每年稳步增长',
				level: 4,
				effects: {
					intelligence: 2,
					vitality: 2,
					tag: 'lobster-infinite',
				},
			},
			{
				id: 503,
				name: '三百六十度感知',
				desc: '小龙虾特殊感知系统，能感知四面八方',
				effectDesc: '智力+4，运气+2 | 大幅提高避开危险概率',
				level: 3,
				effects: {
					intelligence: 4,
					luck: 2,
					tag: 'lobster-perception',
				},
			},
			{
				id: 504,
				name: '铁甲防御',
				desc: '坚硬虾壳就是最好的防御',
				effectDesc: '活力+6 | 大幅降低物理伤害',
				level: 3,
				effects: { vitality: 6, tag: 'lobster-armor' },
			},
			{
				id: 505,
				name: '夜行猎手',
				desc: '习惯在黑夜行动，视力比普通人好',
				effectDesc: '幸运+5 | 更容易发现夜间机会',
				level: 2,
				effects: { luck: 5, tag: 'lobster-night' },
			},
			{
				id: 506,
				name: '洞穴大师',
				desc: '天生会打洞，知道怎么找到最安全的藏身之处',
				effectDesc: '智力+3，活力+3 | 大幅降低天灾死亡概率',
				level: 3,
				effects: { intelligence: 3, vitality: 3, tag: 'lobster-cave' },
			},
			{
				id: 507,
				name: '端粒酶永生',
				desc: '小龙虾端粒酶不会失活，理论上可以永生',
				effectDesc: '活力+3，运气+3 | 极大提高修仙成功概率',
				level: 5,
				effects: {
					vitality: 3,
					luck: 3,
					tag: 'lobster-immortal',
					tag2: 'cultivate',
				},
			},
		],
	...
	randomTalents() {
		...
		while (selected.length < 10 && talentPool.length > 0) {
			// 计算总权重
			let totalWeight = talentPool.reduce(
				(sum, t) => sum + weightMap[t.level],
				0
			);
	...
	randomAttrs() {
		...
		// 随机选出1~2个"天赋强项"，优先分配更多点数，制造3:7分歧感
		const shuffled = [...keys].sort(() => Math.random() - 0.5);
		const strongCount = Math.random() < 0.5 ? 1 : 2;
		const strongKeys = shuffled.slice(0, strongCount);
	...
	selectTalent(e) {
		...
		// dataset 传来的 id 可能是字符串，用 == 宽松比较兼容数字和字符串类型
		...
		if (talent.selected) {
			...
			if (index !== -1) selectedTalents.splice(index, 1);
		} else {
			// 最多选3个
	...
	startGame() {
		...
		this.data.selectedTalents.forEach((talent) => {
			for (const [key, val] of Object.entries(talent.effects)) {
				if (key === 'tag' || key === 'tag2') {
					if (val && !talentTags.includes(val)) {
						talentTags.push(val);
					}
